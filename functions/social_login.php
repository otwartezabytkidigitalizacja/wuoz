...
function do_social_login_buttons() {
	...
	if($fb || $tw || $gp) {
		...
		echo '</div>';
		//242492509240984
		//670c7dc105942e1f627edf245858fa71

		//1648379805420253
		//ddece639a880fce2dd016847c8263005

		//http://wuoz.otwartezabytki.pl/

		//google
		//349576897701.apps.googleusercontent.com
		//aqdu7wWDs336gpXp6y7Rij9E
	}
}